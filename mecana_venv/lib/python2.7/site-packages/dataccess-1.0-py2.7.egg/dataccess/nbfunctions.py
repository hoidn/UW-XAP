...
def run_xrd(query_labels, bgsub = False, queue = 'psfehq', **kwargs):
    ...
    if bsub:
        ...
        from dataccess import xrd
        xrd.main(['quad2'], query_labels, bgsub = bgsub, **kwargs)
...
def batch_preprocess(run_number):
    import os
    os.system(r'bsub -n 1 -q psanaq -o batch_logs/%J.log ' + 'mecana.py -n datashow quad2 ' + str(run_number))
